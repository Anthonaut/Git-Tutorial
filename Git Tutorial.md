...
![](github_first_push_quiz_game_code.png)
<br>
...
![](github_first_push_quiz_game_run_code.png)
...
![](git_checkout_score_feature.png)
...
![](git_commit_score_feature_branch.png)
...
![](git_checkout_score_feature_to_main.png)

Now type `git merge score-feature`:
![](git_merge_score_feature_to_main.png)
...
![](git_push_score_feature_wo_args.png)
...
![](github_repo_score_feature_commit_message.png)

And you'll even see the code for the score feature if you click on the file:
![](github_repo_score_feature_code.png)
